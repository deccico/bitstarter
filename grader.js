...
if(require.main == module) {
    program
        ...
        .option('-u, --url <url_location>', 'Url of the file to check', null, null)
        .parse(process.argv);
    var html_content;
    if (program.url != null){
        ...
        html_content = fs.readFileSync(program.file);
    }
    var checkJson = checkHtmlFile(html_content, program.checks);
